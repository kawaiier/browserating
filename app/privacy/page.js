  ...
  return (
    <section className="max-w-4xl mx-auto p-10 my-12 bg-gray-50 rounded-lg shadow-md">
      ...
      <p className="mb-4">
        ...
        information when you use our website. We are committed to ensuring the
        privacy and security of your data while providing you with a transparent
        understanding of our practices.
      </p>

      <h3 className="text-2xl font-semibold mb-4">Information We Collect</h3>

      <h4 className="text-xl font-semibold mb-2">Newsletter Subscription</h4>
      <ul className="list-disc pl-6 mb-4">
        ...
        <li>
          Your email address is used solely for sending you our newsletter and
      ...
      <p className="mb-4">
        ...
        parties. We only work with the following service providers who help us
        operate our website:
      </p>
      <ul className="list-disc pl-6 mb-4">
      ...
      <p className="mb-4">
        ...
        Your email address is stored securely through our newsletter service
        provider.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li>
          Request deletion of your email address from our newsletter database.
        </li>
      </ul>
