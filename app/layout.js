...
export const metadata = {
  ...
  keywords:
    'browser performance, browser benchmark, Speedometer 3.1, browser comparison, fastest browser, macOS browser, Windows browser, Android browser, iPad browser, adblocking quality, RAM usage, browser speed test, browser rankings, best browser 2026, browser performance comparison, web browser benchmarks, browser efficiency, browser memory usage, browser testing, browser performance metrics',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Comprehensive performance comparison of web browsers (Chrome, Firefox, Safari, Edge, Brave, etc.) across macOS, Windows, Android and iPad platforms. Metrics include Speedometer 3.1 scores, RAM consumption, and ad-blocking effectiveness.',
              keywords: [
                'browser performance',
                'browser benchmark',
                'Speedometer 3.1',
