...
export default function Header() {
  return (
    <header className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white py-12">
      {/* Background Pattern */}
        ...
        <defs>
          ...
          >
            <path
              ...
              strokeWidth="1"
            />
            <circle cx="20" cy="20" r="2" fill="#7853E0" fillOpacity="0.15" />
          </pattern>
        </defs>
      ...
      <div className="container mx-auto px-4">
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto">
          ...
          <div className="w-full md:w-2/3 text-center md:text-left md:pl-8">
            ...
            <h2 className="text-xl md:text-2xl font-medium text-gray-600 leading-relaxed">
              Browser Performance Ranking for
              <span className="inline-flex gap-1.5 ml-2">
                <span className="text-purple-600 font-semibold">macOS</span>
                <span className="text-gray-400">/</span>
                <span className="text-blue-600 font-semibold">Windows</span>
                <span className="text-gray-400">/</span>
